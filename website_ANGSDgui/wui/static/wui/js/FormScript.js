...
var getAnalysis = function(){
    ...
    var AnalysisName = Analysis.options[Analysis.selectedIndex].value;
    ...
    if (Analysis.options[Analysis.selectedIndex].value) {
        ...
        // JsonAnalysis is the analysis id in JSON file
        for (var JsonAnalysis in Json) {
            ...
            if (AnalysisName == JsonAnalysis){
                ...
                var InfileTypes = Json[JsonAnalysis].Infiles;
