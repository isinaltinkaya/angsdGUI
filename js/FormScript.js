...
//var getJSON = $.ajax({
    ...
    //success: function (data) {
        //Json = getJSON.responseJSON;
    //}
//});
//var text = localStorage.getItem("angsd.json");
...
var ocInfileType = function(){
    ...
    if (InfileType){
        ...
        if (InfileType.options[InfileType.selectedIndex].text){
            ...
            Software = Json[AnalysisName].Software[AnalysisInfile];
...
var getSoftwarePath = function(Software){
    ...
    if(SoftwarePath){
        ...
        return Json.Softwares[Software].Call;
    }
    return;
}
...
var addSoftwarePath = function(Software){
    ...
    */
    var SoftwareInfo = Json.Softwares[Software]
...
var getAnalysis = function(){
    ...
    if (Analysis.options[Analysis.selectedIndex].value) {
        ...
        var InfileTypes = Json[AnalysisName].Infiles;
